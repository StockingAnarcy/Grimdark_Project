...
namespace PLAYERTWO.PlatformerProject
{
    ...
    public class FootIKController : MonoBehaviour
    {
        ...
        public string leftFootAnimVariableName = "Left Foot Q";
        public string rightFootAnimVariableName = "Right Foot Q";
        ...
        private void FixedUpdate()
        {
            ...
            FeetPositionSolver(leftFootPosition, ref leftFootIkPosition, ref leftFootIkRotation);//Solver for left foot
